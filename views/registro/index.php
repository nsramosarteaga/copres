	...
	<div class="row" id="div_loading">
		<div class="col-md-4 col-md-push-4">
			<div class="box box-warning box-solid">
				...
				<div class="box-body"><?=$lang['frm_registro']['guardando']?></div><!-- /.box-body -->
	...
	<div class="row" id="div_success">
		<div class="col-md-4 col-md-push-4">
			<div class="box box-success box-solid">
                ...
                <div class="box-body"><?=$lang['sistema']['guardado_existoso']?></div><!-- /.box-body -->
...
foreach ($array_tdo as $row) {
	echo '<option value="'.$row['tdo_str_referencia'].'">'.$row['tdo_str_referencia'].' - '.$row['tdo_str_descripcion'].'</option>';
}
?>
									</select>
								</div>
...
foreach ($array_genero as $row) {
	echo '<option value="'.$row['sex_str_referencia'].'">'.$row['sex_str_referencia'].' - '.$row['sex_str_descripcion'].'</option>';
}
?>
									</select>
								</div>
...
foreach ($array_area as $row) {
	echo '<option value="'.$row['are_str_referencia'].'">'.$row['are_str_referencia'].' - '.$row['are_str_descripcion'].'</option>';
}
?>
									</select>
								</div>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" class="form-control input_capital" data-parsley-length="[7, 16]" id="pob_str_telefono" name="pob_str_telefono">
								</div>
							</div>
							<div class="col-md-8">
								<div class="form-group">
									<label><?=$lang['frm_registro']['correo']?></label>
									<input type="email" class="form-control" id="pob_str_correo" name="pob_str_correo" placeholder="micorreo@midominio.com">
								</div>
							</div>
...
foreach ($array_eps as $row) {
	echo '<option value="'.$row['eps_str_codigo'].'">'.$row['eps_str_nombre'].' ['.$row['eps_str_codigo'].']</option>';
}
?>
									</select>
								</div>
...
foreach ($array_cpoblacion as $row) {
	echo '<option value="'.$row['cpo_num_codigo'].'">'.$row['cpo_num_codigo'].' - '.$row['cpo_str_descripcion'].'</option>';
}
?>
									</select>
								</div>
...
foreach ($array_nivel as $row) {
	echo '<option value="'.$row['niv_str_referencia'].'">'.$row['niv_str_referencia'].'</option>';
}
?>
									</select>
								</div>
...
foreach ($array_tno as $row) {
	echo '<option value="'.$row['tno_str_referencia'].'">'.$row['tno_str_descripcion'].' ['.$row['tno_str_referencia'].']</option>';
}
?>
									</select>
								</div>
...
foreach ($array_estado as $row) {
	echo '<option value="'.$row['est_str_referencia'].'">'.$row['est_str_referencia'].' - '.$row['est_str_descripcion'].'</option>';
}
?>
									</select>
								</div>
