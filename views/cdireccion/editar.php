    ...
    <div class="row" id="div_formulario">
        <div class="col-md-4 col-md-push-4">
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title"><?=$lang['mantenimiento']['cdireccion_editar']?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    ...
                    <form role="form" id="formulario_cdireccion" data-parsley-validate="">
                        <input type="hidden" id="cdi_id" name="cdi_id" value="<?=$cdireccion['cdi_id']?>">
                        <div class="box-body">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label><?=$lang['frm_cdireccion']['nombre']?></label>
                                    <input type="text" class="form-control input_capital" required="" data-parsley-length="[4, 128]" id="cdi_str_nombre" name="cdi_str_nombre" value="<?=$cdireccion['cdi_str_nombre']?>">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="cdi_str_tipo" id="cdi_str_tipo" required="">
                                        ...
                                        <option value="B" <?php if($cdireccion['cdi_str_tipo']==='B') echo "selected"?> >Barrio</option>
                                        <option value="V" <?php if($cdireccion['cdi_str_tipo']==='V') echo "selected"?>  >Vereda</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="btn_modificar_cdireccion"><?=$lang['sistema']['btn_modificar']?></button>
                </div>
