    ...
    <div class="row" id="div_formulario">
        <div class="col-md-4 col-md-push-4">
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title"><?=$lang['mantenimiento']['eps_editar']?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    ...
                    <form role="form" id="formulario_eps" data-parsley-validate="">
                        <input type="hidden" id="eps_id" name="eps_id" value="<?=$eps['eps_id']?>">
                        <div class="box-body">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label><?=$lang['frm_eps']['codigo']?></label>
                                    <input type="text" class="form-control input_capital" required="" data-parsley-type="alphanum" data-parsley-length="[2, 16]" placeholder="Solo números y letras" id="eps_str_codigo" name="eps_str_codigo" value="<?=$eps['eps_str_codigo']?>">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label><?=$lang['frm_eps']['nombre']?></label>
                                    <input type="text" class="form-control input_capital" required="" data-parsley-length="[4, 128]" id="eps_str_nombre" name="eps_str_nombre" value="<?=$eps['eps_str_nombre']?>">
                                </div>
                            </div>
                        </div>
                    </form><!-- /form -->
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="btn_modificar_eps"><?=$lang['sistema']['btn_modificar']?></button>
                </div>
